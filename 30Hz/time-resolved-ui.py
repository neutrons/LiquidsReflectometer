...
class ReductionInterface(QWidget):
    ...
    def __init__(self):
        ...
        self.template_path = QLabel(self.tab_widget)
        ...
        self.ref_path = QLabel(self.tab_widget)
        ...
        self.ref_run_number_label = QLabel(self.tab_widget)
        ...
        self.data_run_number_label = QLabel(self.tab_widget)
        ...
        self.time_slice_label = QLabel(self.tab_widget)
        ...
        self.output_dir_label = QLabel(self.tab_widget)
    ...
    def reduce(self):
        ...
        subprocess.run(['python3', 'template_reduction.py',
