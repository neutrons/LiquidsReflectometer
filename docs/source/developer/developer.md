...
We use [pixi](https://pixi.sh/latest/) to create the virtual environment for local development of the project,
...
See the [pixi installation page](https://pixi.sh/latest/installation/) for more options.
...
To achieve this, install [direnv](https://pixi.sh/latest/integration/third_party/direnv/)
...
[reporting on a nagging, albeit harmless, error message](https://github.com/direnv/direnv/wiki/PS1).
...
[lr_reduction-data](https://code.ornl.gov/sns-hfir-scse/infrastructure/test-data/liquidsreflectometer-data).
...
[Confluence pages](https://ornl-neutrons.atlassian.net/wiki/spaces/NDPD/pages/19103745/Using+git-lfs+for+test+data)
(login required).

## Coverage reports

GitHub actions create reports for unit and integration tests, then combine into one report and upload it to
[Codecov](https://app.codecov.io/gh/neutrons/lr_reduction).
