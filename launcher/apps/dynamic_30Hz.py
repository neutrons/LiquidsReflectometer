...
class Dynamic30Hz(QWidget):
    ...
    def save_settings(self):
        ...
        self.settings.setValue(
            "30Hz_data_run_number", self.data_run_number_ledit.text()
        )
    ...
    def reduce_q(self):
        return self.reduce(
            reduction_script="scripts/time_resolved_reduction.py", q_summing=True
        )

    def reduce(
        self, reduction_script="scripts/time_resolved_reduction.py", q_summing=False
    ):
