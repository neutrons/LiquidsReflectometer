...
class Refracted(object):
    ...
    def fit_refracted_pixel(self):
        ...
        for i in range(self.p_vs_t.shape[1]):
            ...
            fit = gauss.fit(self.p_vs_t[y_pixel_min:y_pixel_max, i], pars, method="leastsq", x=self.y_pixel[y_pixel_min:y_pixel_max])
    ...
    def plot_refraction_map(self, output_dir=None):
        ...
        _theta_boundaries = self.compute_angle_from_pixel(pixel_boundaries, pixel_size=self.pixel_size, offset=self.offset)
