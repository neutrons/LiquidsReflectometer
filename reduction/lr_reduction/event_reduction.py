...
class EventReflectivity(object):
    ...
    def _bck_subtraction(
        self, ws, peak, bck, low_res, normalize_to_single_pixel=False, q_bins=None, wl_dist=None, wl_bins=None, q_summing=False
    ):
        """
    ...
    def norm_bck_subtraction(self):
        ...
        """
        return self._bck_subtraction(self._ws_db, self.norm_peak, self.norm_bck, self.norm_low_res, normalize_to_single_pixel=False)

    def slice(self, x_min=0.002, x_max=0.004, x_bins=None, z_bins=None, refl=None, d_refl=None, normalize=False):  # noqa  A003
        """
