...
class ReductionParameters:
    ...
    def to_xml(self):
        ...
        _xml += "<wavelength_resolution_dLambda_formula>%s</wavelength_resolution_dLambda_formula>\n" % str(self.wavelength_resolution_dLambda_formula)
        _xml += "<wavelength_resolution_dLambda_initial_parameters>%s</wavelength_resolution_dLambda_initial_parameters>\n" % str(self.wavelength_resolution_dLambda_initial_parameters)
