...
def test_full_reduction():
    ...
    """
    template_path = 'reduction/data/template.xml'
...
def test_reduce_workflow_201282():
    ...
    """
    template_path = 'reduction/data/template_201282.xml'
    output_dir = '/tmp'
    ...
    reference_path = 'reduction/data/reference_rq_201282.txt'
    if os.path.isfile(reference_path):
        _data = np.loadtxt(reference_path).T
...
def test_background_subtraction():
    ...
    """
    template_path = 'reduction/data/template_short_nobck.xml'
    output_dir = '/tmp'
    ...
    reference_path = 'reduction/data/reference_short_nobck.txt'
    if os.path.isfile(reference_path):
        _data = np.loadtxt(reference_path).T
