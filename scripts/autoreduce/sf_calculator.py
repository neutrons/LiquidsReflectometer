...
class ScalingFactor(object):
    def __init__(self, run_list, sort_by_runs=True, sf_file="test.cfg", tof_step=200, medium="Si", slit_tolerance=0.06, dry_run=False):
    ...
    def find_peak_scipy(self, ws):
        ...
        _crop = 25
        peaks, props = find_peaks(counts[_crop:-_crop], threshold=None, width=3, prominence=0.5 * avg)
