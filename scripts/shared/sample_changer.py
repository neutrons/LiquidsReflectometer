...
POSITIONS = [
    dict(ysc=50, hs=9, ths=-3.7, chis=0, zs=199.2, xs=0, ys=6.002),
...
SCAN = [
    [
        6000,
        {
            "BL4B:Chop:Gbl:WavelengthReq": 15,
            "s1:Y:Gap": 0.39,
            "si:Y:Gap": 0.25,
            "s3:Y:Gap": 10,
            "ths": 0.6,
    ...
    [
        6000,
        {
            "BL4B:Chop:Gbl:WavelengthReq": 12.386,
            "s1:Y:Gap": 0.39,
            "si:Y:Gap": 0.25,
            "s3:Y:Gap": 10,
            "ths": 0.6,
    ...
    [
        6000,
        {
            "BL4B:Chop:Gbl:WavelengthReq": 9.74,
            "s1:Y:Gap": 0.39,
            "si:Y:Gap": 0.25,
            "s3:Y:Gap": 10,
            "ths": 0.6,
    ...
    [
        6000,
        {
            "BL4B:Chop:Gbl:WavelengthReq": 7.043,
            "s1:Y:Gap": 0.39,
            "si:Y:Gap": 0.25,
            "s3:Y:Gap": 10,
            "ths": 0.6,
    ...
    [
        18000,
        {
            "BL4B:Chop:Gbl:WavelengthReq": 4.25,
            "s1:Y:Gap": 0.39,
            "si:Y:Gap": 0.25,
            "s3:Y:Gap": 10,
            "ths": 0.6,
...
if __name__ == "__main__":
    positions = [dict(name="quartz", pos=1), dict(name="SiO2", pos=2)]
    process(positions)
