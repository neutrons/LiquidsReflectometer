...
class LiveEntrypoint(Entrypoint[SingleRunResult]):
    ...
    def call_operations(self, config: ReductionConfig, _data: EventWorkspace) -> SingleRunResult:
...
def reduce_live(reflected_run: EventWorkspace, **overrides) -> SingleRunResult:
