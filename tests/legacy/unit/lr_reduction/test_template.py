...
from lr_reduction.legacy.template import get_default_template_file, process_from_template_ws
...
def test_process_from_template_ws_selects_theta_log(monkeypatch, logs, expected_theta):
    ...
    monkeypatch.setattr("lr_reduction.legacy.template.event_reduction.EventReflectivity", _DummyEventReflectivity)
