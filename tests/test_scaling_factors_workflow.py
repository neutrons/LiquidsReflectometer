...
def test_compute_sf(nexus_dir, template_dir):
    """
...
def test_compute_sf_with_deadtime(nexus_dir, template_dir):
    """
    Test the computation of scaling factors
    """
    with amend_config(data_dir=nexus_dir):
...
def test_compute_sf_with_deadtime_tof_300(nexus_dir, template_dir):
    """
    Test the computation of scaling factors
    """
    with amend_config(data_dir=nexus_dir):
...
def test_compute_sf_with_deadtime_tof_200(nexus_dir, template_dir):
    """
    Test the computation of scaling factors
    """
    with amend_config(data_dir=nexus_dir):
...
def test_compute_sf_with_deadtime_tof_200_sort(nexus_dir, template_dir):
    """
    Test the computation of scaling factors
    """
    with amend_config(data_dir=nexus_dir):
